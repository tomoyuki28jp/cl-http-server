...
(defstruct server
  ...
  (public-dir             "/tmp/clhs/public/"  :type string)
  (rewrite-rule           nil                   :type symbol)
  (route                  (make-route)          :type route)
  (session-save-dir       "/tmp/clhs/session/" :type string)
  (log-save-dir           "/tmp/clhs/log/"     :type string)
  (upload-tmp-dir         "/tmp/clhs/tmp/"     :type string)
